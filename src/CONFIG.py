GOOGLE_CLIENT_SECRET_FILENAME = 'client_secret.json'  # cwd filename
GOOGLE_DOCS_LINK = 'https://docs.google.com/spreadsheets/d/1oRedPa92QILDHDlBwsT1EYUpqn92ZuYY7Foc1Muy4Rk'
